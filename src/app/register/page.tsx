                    ...
                    <div className="flex flex-col gap-7 w-full max-w-sm">
                        ...
                        <div className="flex flex-col items-center gap-7">
                            ...
                            <div className="flex items-center w-full gap-4">
                                ...
                                <button type="button" className="flex flex-1 items-center justify-center px-4 py-2 border gap-2 border-slate-200 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
